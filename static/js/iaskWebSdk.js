(function () {
  ...
  const sdk = function (params) {
    ...
    const DEFAULT_CONFIG = {
      ...
      // PV指标自动触发配置
      pageview: params.PAGEVIEW !== false,
    ...
    const PRODUCT_CONFIG = params.PRODUCT_CONFIG
    if (!PRODUCT_CONFIG) {
    ...
    // People类属性事件id，全局唯一
    const PEOPLE_PROPERTY_ID = 'user_property'

    // -------------设备型号等信息--------------
    // userAgentBase
    const userAgentBase = (function () {
      let match
      ...
      Detected.prototype = {
        ...
        detect (ua) {
           ...
           *
           *      Mozilla/5.0 (FreeBSD; U; Viera; ja-JP) AppleWebKit/535.1 (KHTML, like Gecko) Viera/1.2.4
           ...
           *      Mozilla/5.0 (DTV) AppleWebKit/531.2+ (KHTML, like Gecko) Espial/6.0.4 AQUOSBrowser/1.0
           * (CH00DTV;V;0001;0001) Opera/9.80 (Linux armv6l; U; en) Presto/2.8.115 Version/11.10 AQUOS-AS/1.0
           * LC-40LE835X
           */
           ...
           *      Samsung Smart TV
           *
           *      Mozilla/5.0 (SmartHub; SMART-TV; U; Linux/SmartTV; Maple2012) AppleWebKit/534.7 (KHTML, like Gecko)
           * SmartTV Safari/534.7 Mozilla/5.0 (SmartHub; SMART-TV; U; Linux/SmartTV) AppleWebKit/531.2+ (KHTML, like
           * Gecko) WebBrowser/1.0 SmartTV Safari/531.2+
           */
           ...
           *      Sony Internet TV
           *
           *      Opera/9.80 (Linux armv7l; U; InettvBrowser/2.2(00014A;SonyDTV115;0002;0100) KDL-46EX640; CC/USA; en)
           * Presto/2.8.115 Version/11.10 Opera/9.80 (Linux armv7l; U; InettvBrowser/2.2(00014A;SonyDTV115;0002;0100)
           * KDL-40EX640; CC/USA; en) Presto/2.10.250 Version/11.60 Opera/9.80 (Linux armv7l; U;
           * InettvBrowser/2.2(00014A;SonyDTV115;0002;0100) N/A; CC/USA; en) Presto/2.8.115 Version/11.10 Opera/9.80
           * (Linux mips; U; InettvBrowser/2.2 (00014A;SonyDTV115;0002;0100) ; CC/JPN; en) Presto/2.9.167 Version/11.50
           * Opera/9.80 (Linux mips; U; InettvBrowser/2.2 (00014A;SonyDTV115;0002;0100) AZ2CVT2; CC/CAN; en)
           * Presto/2.7.61 Version/11.00 Opera/9.80 (Linux armv6l; Opera TV Store/4207; U; (SonyBDP/BDV11); en)
           * Presto/2.9.167 Version/11.50 Opera/9.80 (Linux armv6l ; U; (SonyBDP/BDV11); en) Presto/2.6.33
           * Version/10.60 Opera/9.80 (Linux armv6l; U; (SonyBDP/BDV11); en) Presto/2.8.115 Version/11.10
           */
           ...
           *      Opera/9.80 (Linux mips; U; CE-HTML/1.0 NETTV/3.0.1; PHILIPS-AVM-2012; en) Presto/2.9.167
           * Version/11.50
           *      Opera/9.80 (Linux mips ; U; HbbTV/1.1.1 (; Philips; ; ; ; ) CE-HTML/1.0 NETTV/3.1.0; en)
           * Presto/2.6.33 Version/10.70 Opera/9.80 (Linux i686; U; HbbTV/1.1.1 (; Philips; ; ; ; ) CE-HTML/1.0
           * NETTV/3.1.0; en) Presto/2.9.167 Version/11.50
           */
           ...
           *      LG NetCast TV
           *
           *      Mozilla/5.0 (DirectFB; Linux armv7l) AppleWebKit/534.26+ (KHTML, like Gecko) Version/5.0
           * Safari/534.26+ LG Browser/5.00.00(+mouse+3D+SCREEN+TUNER; LGE; GLOBAL-PLAT4; 03.09.22; 0x00000001;); LG
           * NetCast.TV-2012 Mozilla/5.0 (DirectFB; Linux armv7l) AppleWebKit/534.26+ (KHTML, like Gecko) Version/5.0
           * Safari/534.26+ LG Browser/5.00.00(+SCREEN+TUNER; LGE; GLOBAL-PLAT4; 01.00.00; 0x00000001;); LG
           * NetCast.TV-2012 Mozilla/5.0 (DirectFB; U; Linux armv6l; en) AppleWebKit/531.2  (KHTML, like Gecko)
           * Safari/531.2  LG Browser/4.1.4( BDP; LGE; Media/BD660; 6970; abc;); LG NetCast.Media-2011 Mozilla/5.0
           * (DirectFB; U; Linux 7631; en) AppleWebKit/531.2  (KHTML, like Gecko) Safari/531.2  LG Browser/4.1.4(
           * NO_NUM; LGE; Media/SP520; ST.3.97.409.F; 0x00000001;); LG NetCast.Media-2011 Mozilla/5.0 (DirectFB; U;
           * Linux 7630; en) AppleWebKit/531.2  (KHTML, like Gecko) Safari/531.2  LG Browser/4.1.4( 3D BDP NO_NUM; LGE;
           * Media/ST600; LG NetCast.Media-2011
           ...
           *      Toshiba Smart TV
           *
           *      Mozilla/5.0 (Linux mipsel; U; HbbTV/1.1.1 (; TOSHIBA; DTV_RL953; 56.7.66.7; t12; ) ; ToshibaTP/1.3.0
           * (+VIDEO_MP4+VIDEO_X_MS_ASF+AUDIO_MPEG+AUDIO_MP4+DRM+NATIVELAUNCH) ; en) AppleWebKit/534.1 (KHTML, like
           * Gecko) Mozilla/5.0 (DTV; TSBNetTV/T32013713.0203.7DD; TVwithVideoPlayer; like Gecko) NetFront/4.1
           * DTVNetBrowser/2.2 (000039;T32013713;0203;7DD) InettvBrowser/2.2 (000039;T32013713;0203;7DD) Mozilla/5.0
           * (Linux mipsel; U; HbbTV/1.1.1 (; TOSHIBA; 40PX200; 0.7.3.0.; t12; ) ; Toshiba_TP/1.3.0
           * (+VIDEO_MP4+AUDIO_MPEG+AUDIO_MP4+VIDEO_X_MS_ASF+OFFLINEAPP) ; en) AppleWebKit/534.1 (KHTML, like Gec
           */
          ...
          if (this.options.detectCamouflage) {
            ...
            if (this.options.useFeatures) {
              ...
              if (this.engine.name === 'Webkit' && !{}.toString.toString().includes('\n')) {
    ...
    const userAgent = function (ua) {
      ...
      if (uaData.device.type === 'mobile' || uaData.device.type === 'tablet') {
        ...
        if (match = ua.match(/(ZTE|Samsung|Motorola|HTC|Coolpad|Huawei|Lenovo|LG|Sony Ericsson|Oppo|TCL|Vivo|Sony|Meizu|Nokia)/i)) {
          ...
          if (uaData.device.model && uaData.device.model.includes(match[1])) {
      ...
      if (uaData.device.type === 'desktop') {
        ...
        /**
         * 'Mozilla/5.0 (iPad; CPU OS 5_1_1 like Mac OS X) AppleWebKit/534.46 (KHTML, like Gecko) Mobile/9B206' belongs
         * to Safari
         */
    ...
    const DEVICEINFO = new userAgent(ua)

    const utf8Encode = function utf8Encode (string) {
    ...
    const base64Encode = function base64Encode (data) {
    ...
    _.register_event = (function () {
       ...
       */
      const register_event = function register_event (element, type, handler, oldSchool, useCapture) {
        if (!element) {
    ...
    _.innerEvent = {
      ...
      trigger: function trigger () {
        ...
        const key = args[0]
        const arrFn = this._list && this._list[key]
    ...
    var console = {
      ...
      error: function error () {
        if (SYSTEM_CONFIG.DEBUG && !_.isUndefined(windowConsole) && windowConsole) {
          const args = ['DATracker error:'].concat(_.toArray(arguments))
          try {
      ...
      warn: function warn () {
        if (SYSTEM_CONFIG.DEBUG && !_.isUndefined(windowConsole) && windowConsole) {
          const args = ['DATracker warn:'].concat(_.toArray(arguments))
          try {
    ...
    const USER_TRACK = (function () {
      ...
      _createClass(USER_TRACK, [{
        ...
        value: function _is_reserved_property (prop) {
          return PEOPLE_RESERVED_PROPERTY.includes('prop')
        }
        /**
         * 上报用户属性数据
        ...
        value: function _send_request (properties, callback) {
          ...
          const callback_fn = function callback_fn (response) {
    ...
    const EVENT_TRACK = (function () {
         ...
         */
      {
        ...
        value: function _session (callback) {
          const session_start_time = Number(this.instance.get_property('sessionStartTime')) / 1000
          const updated_time = Number(this.instance.get_property('updatedTime')) / 1000
          const now_date_time_ms = new Date().getTime()
          const now_date_time_se = now_date_time_ms / 1000
    ...
    const LOCAL_STORAGE = (function () {
      ...
      function LOCAL_STORAGE (config) {
        ...
        if (_.isObject(local_storage)) {
          ...
          const storage_type = local_storage.type || 'cookie'

          // 判断是否支持 localStorage
          const localStorage_supported = function localStorage_supported () {
            let supported = true
            try {
              const key = '__smartssupport__'
              const val = 'web_data_sdk'
